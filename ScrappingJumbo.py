...
try:
    df.to_csv('D:/Curso Udemy/Scrapping/jumbo_db2.csv', encoding='utf-8')
    error_product_read.to_csv('D:/Curso Udemy/Scrapping/jumbo_db2_errors.csv', encoding='utf-8')
except:
    df_tmp = df
    df_error = error_product_read
